...
class BinanceTrader(object):
    ...
    def __init__(self):
        ...
        """
        self.http_client = BinanceSpotHttp(domain=config.api_domain, api_key=config.api_key, secret=config.api_secret, proxy_host=config.proxy_host, proxy_port=config.proxy_port)
